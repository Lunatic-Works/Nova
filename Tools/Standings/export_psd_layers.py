...
def save_layer(layer, layer_name):
    ...
    img[layer.top:layer.bottom, layer.left:layer.right, :] = layer.numpy()
...
def walk(layer, layer_name):
    ...
    elif (isinstance(layer, psd_tools.api.layers.Group)
          or isinstance(layer, psd_tools.api.psd_image.PSDImage)):
        for child in layer:
