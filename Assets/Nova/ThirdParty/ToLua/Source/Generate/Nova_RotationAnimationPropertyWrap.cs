...
public class Nova_RotationAnimationPropertyWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Nova.RotationAnimationProperty), typeof(Nova.LazyComputableAnimationProperty<UnityEngine.Quaternion,UnityEngine.Quaternion>));
		L.RegFunction("New", _CreateNova_RotationAnimationProperty);
