namespace Nova
{
    ...
    /// appreciated to include useless utililty data in this object, neither to hold any reference to assets.
    /// All the data will be stored in the game state object.
    /// Though not necessary, it is recommanded to design the implementation of this interface as immutable.
    /// </remarks>
